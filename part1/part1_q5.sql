...
((SELECT dog_id FROM Dogs WHERE name = 'dog2' AND owner_id = (SELECT user_id FROM Users WHERE username = 'user2')), '2025-06-11 14:00:00', 30, 'Riverside Trail', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'dog3' AND owner_id = (SELECT user_id FROM Users WHERE username = 'alice123')), '2025-06-12 16:00:00', 40, 'Greenwich Gardens', 'completed');
